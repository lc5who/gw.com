<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/wwwroot/mygw.com/public/../application/index/view/index/newsdetail.html";i:1598099186;s:63:"/www/wwwroot/mygw.com/application/index/view/common/header.html";i:1598099624;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                        ...
                        <a class="dropdown-item" href="<?php echo url('index/yuanma'); ?>"><?php echo $vo['name']; ?></a>
