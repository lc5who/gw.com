<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/www/wwwroot/mygw.com/public/../application/admin/view/content/app/edit.html";i:1598099316;s:64:"/www/wwwroot/mygw.com/application/admin/view/layout/default.html";i:1583049507;s:61:"/www/wwwroot/mygw.com/application/admin/view/common/meta.html";i:1583049507;s:63:"/www/wwwroot/mygw.com/application/admin/view/common/script.html";i:1583049507;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id" data-rule="required" data-source="category/selectpage" data-params='{"custom[type]":"app"}' class="form-control selectpage" name="row[category_id]" type="text" value="<?php echo htmlentities($row['category_id']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-switch" data-rule="required" class="form-control" name="row[switch]" type="number" value="<?php echo htmlentities($row['switch']); ?>">
        </div>
    </div>
    <div class="form-group">
